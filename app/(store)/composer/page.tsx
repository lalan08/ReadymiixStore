...
const PRODUCTS = [
  {
    ...
    emoji:       "🍬",
    basePrice:   5,
    description: "Léger et fruité — Haribo, bonbons Jitty Shocks, popping candy et surprises fruitées. Pour tous les goûts, à tout moment.",
    image:       "https://images.unsplash.com/photo-1570197788417-0e82375c9371?w=800&q=80",
    accent:      "#00D2C8",
    tags:        ["Sans alcool fort", "Bonbons inclus", "Pour tous"],
    Icon:        Candy,
  },
  {
    type:        "hard" as const,
    ...
    emoji:       "🔥",
    basePrice:   7,
    description: "Avec Hennessy et alcools forts, garni de bonbons. Pour les amateurs qui veulent du caractère et de la puissance.",
    image:       "https://images.unsplash.com/photo-1551538827-9c037cb4f32a?w=800&q=80",
    accent:      "#F72585",
    tags:        ["Hennessy", "Alcool fort", "Pour amateurs"],
    Icon:        Flame,
  },
];
